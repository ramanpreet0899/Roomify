...
public class ChatActivity extends AppCompatActivity {
    ...
    private void getOtherDeviceToken() {
        DatabaseReference databaseReferencetoken = FirebaseDatabase.getInstance().getReference()
                .child("TokenN");
        databaseReferencetoken.child(otherUserId).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mFirebaseRefMessage.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot msgSnapshot : dataSnapshot.getChildren()) {
                   /* if (Objects.equals(msgSnapshot.child("deleted").getValue(), userName)) {
...
//                    recyclerChatScreen.smoothScrollToPosition(chatMsgList.size() - 1);
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (unreadmessageList_value.size() == 2) {
                            ...
                            String image_uri = preferences.getString("image_uri", null);
                            ...
                            //chat_history.setImage(image_uri1);
                            ...
                            // receiverUnreadMessage.put("user_image", image_uri1);
                            ...
                            for (int i = 0; i < mChatHistory.getUser_data().size(); i++) {
                                ...
                                if ((Objects.requireNonNull(userData.get("userid")).equalsIgnoreCase(user_id))) {
    ...
    private void sendNotificationToPartner(final String sender_id, final String receiver_id, final String message, String chat_id) {

        SendNotificationModel sendNotificationModel = new SendNotificationModel(message, "Roomify", "Chat", user_id);
        ...
        requestNotificaton.setToken(mToken);
        requestNotificaton.setChatId(chat_id);
        requestNotificaton.setUserId(sender_id);
        requestNotificaton.setOtherUserId(receiver_id);
        FcmApi apiService;

        apiService = FCMClient.getClient().create(FcmApi.class);

...
public class DetailActivity extends AppCompatActivity {
    ...
    String phone, postUser, username, postId, other_user_image;
    Long mFilterId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cm.setText(textViewLocation.getText());
        ...
        if (postUser != null && postId != null) {
            ...
            StorageReference storageReference = FirebaseStorage.getInstance().getReference().
                    child("ProfileImage").child(postUser);
            storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                @Override
                public void onSuccess(Uri uri) {
                    other_user_image = uri.toString();
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putString("image_uri1", other_user_image);
                    editor.apply();
                ...
                public void onFailure(@NonNull Exception e) {
                    //other_user_image = "gs://findroommate-21a6f.appspot.com/person.jpg";
                    StorageReference storageReference1 = FirebaseStorage.getInstance().getReference()
                            .child("defaultUserImage").child("person.jpg");
        ...
        if (postId != null) {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (!postUser.equals(username)) {
                        buttonContactUser.setVisibility(View.VISIBLE);
                        // buttonContactUser.setBackground(getResources().getDrawable(R.drawable.hide_button));
                    } else {
                        buttonContactUser.setVisibility(View.GONE);
                        //  buttonContactUser.setBackground(getResources().getDrawable(R.drawable.rounded_button));
                    }
        ...
        buttonContactUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String image_uri1 = preferences.getString("image_uri1", null);
                ...
                chat_history.setImage(other_user_image);

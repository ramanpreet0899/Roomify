...
public class Chat {
    ...
    public Chat(String message, String author, String id, String timestamp, String type, String sender_id, String recepient_id, String userImage, String otherUserImage, String otherUserName,String deleted) {
